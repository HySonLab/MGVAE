...
preprocessor = GGNNPreprocessor(max_atoms = max_atoms, out_size=max_atoms, kekulize=True)

print(f'Preprocessing {data_name} data')
df = pd.read_csv(path, index_col=0).head(25000)
print(df.head())
#print(df)
...
NumpyTupleDataset.save(f'/media/Z/minhnh46/khangnn3/mol_gen/zinc250k/ogb_format/{data_name.lower()}_kekulized.npz', dataset)
